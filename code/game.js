...
var wobSpeed = 7;
var wobDist = 0.1;
Low.prototype.act = function (step) {
  this.wobble += step * wobSpeed;
  var wobPos = Math.sin(this.wobble) * wobDist;
...
Player.prototype.moveY = function(step, level, keys) {
  ...
  else if (obstacle == "lava" && this.status == null) {
    this.status = "lost";
...
Level.prototype.playerTouched = function(type, actor) {
  ...
  if (type == "lava" && this.status == null) {
    ...
    gravity = 20;
    console.log("The Gravity's changed!");
  }
